package com.insyslab.tooz.ui.customui.expandablerecyclerview.models;
...
public class ExpandableListPosition {
    ...
    private static ExpandableListPosition obtainGroupPosition(int groupPosition) {
        return obtain(GROUP, groupPosition, 0, 0);
    }

    private static ExpandableListPosition obtainChildPosition(int groupPosition, int childPosition) {
    ...
    static ExpandableListPosition obtain(int type, int groupPos, int childPos,
                                         int flatListPos) {
        ExpandableListPosition elp = getRecycledOrCreate();
        elp.type = type;
    ...
    public boolean equals(Object o) {
        ...
        return flatListPos == that.flatListPos && type == that.type;
