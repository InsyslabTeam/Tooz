...
import com.insyslab.tooz.ui.customui.expandablerecyclerview.listeners.GroupExpandCollapseListener;
import com.insyslab.tooz.ui.customui.expandablerecyclerview.listeners.OnGroupClickListener;
...
import com.insyslab.tooz.ui.customui.expandablerecyclerview.viewholders.ChildViewHolder;
import com.insyslab.tooz.ui.customui.expandablerecyclerview.viewholders.GroupViewHolder;
...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
     ...
     */
    private List<? extends ExpandableGroup> getGroups() {
     ...
     */
    abstract void onBindChildViewHolder(CVH holder, int flatPosition, ExpandableGroup group,
                                        int childIndex);
     ...
     */
    abstract void onBindGroupViewHolder(GVH holder, int flatPosition, ExpandableGroup group);
}
